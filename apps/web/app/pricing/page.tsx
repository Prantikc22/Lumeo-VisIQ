...
const plans = [
  ...
  { name: "Scale", item_price_id: "Scale-USD-Monthly", price: "$699/mo", limit: "1M+ API calls", features: ["Everything in Business", "Dedicated manager", "Custom SLAs"] }
];
...
export default function PricingPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      ...
      {/* --- Feature comparison (drop-in, no logic changes) --- */}
      ...
      <table className="min-w-full border-separate border-spacing-y-2 text-sm">
        <thead>
          <tr>
            ...
            {plans.map((p) => (
              <th key={p.item_price_id} className="text-left text-slate-900 font-semibold p-3">
                {p.name}
              </th>
            ))}
          </tr>
        ...
        <tbody>
          ...
          <tr className="align-top">
            ...
            {plans.map((p) => (
              <td key={p.item_price_id + '-limit'} className="p-3 bg-slate-50 rounded-r-xl">
          ...
          {[
            ...
            <tr key={row} className="align-top">
              ...
              {plans.map((p) => (
                <td key={p.item_price_id + row} className="p-3">
          ...
          <tr className="align-top">
            ...
            {plans.map((p) => {
              ...
              return (
                <td key={p.item_price_id + '-support'} className="p-3">
          ...
          <tr className="align-top">
            ...
            {plans.map((p) => (
              <td key={p.item_price_id + '-sec'} className="p-3 text-slate-700">
          ...
          <tr className="align-top">
            ...
            {plans.map((p) => {
              ...
              return (
                <td key={p.item_price_id + '-retention'} className="p-3">
          ...
          <tr className="align-top">
            ...
            {plans.map((p) => {
              ...
              return (
                <td key={p.item_price_id + '-sla'} className="p-3 text-slate-700">
                  {m[p.name]}
                </td>
              );
            })}
